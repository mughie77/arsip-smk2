    ...
    <div class="card-body">
        ...
        <div class="pagination-container">
            <ul class="pagination-amazon">
                ...
                echo "<li class='page-item $prev_disabled'><a class='page-link' href='klasifikasi_surat.php?" . http_build_query($prev_params) . "'><i class='fas fa-chevron-left'></i></a></li>";
                ...
                echo "<li class='page-item $next_disabled'><a class='page-link' href='klasifikasi_surat.php?" . http_build_query($next_params) . "'><i class='fas fa-chevron-right'></i></a></li>";
                ?>
            </ul>
        </div>

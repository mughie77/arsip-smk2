                    ...
                    <?php if (mysqli_num_rows($result) > 0) : ?>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                            <tr class="hover:bg-slate-50/80 transition-colors group text-sm md:text-base">
                                ...
                                <td class="px-6 py-5 text-sm font-bold text-slate-900"><?php echo htmlspecialchars($row['kegiatan']); ?></td>
                                <td class="px-6 py-5">
                                ...
                                <td class="px-8 py-5 text-right">
                                    <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <a href="notulen_edit.php?id=<?php echo $row['id']; ?>" class="w-9 h-9 flex items-center justify-center rounded-xl bg-amber-50 text-amber-500 hover:bg-amber-500 hover:text-white transition-all shadow-sm">

...
if (!empty($dari_tanggal) && !empty($sampai_tanggal)) {
    ...
    $query .= " WHERE tanggal_kirim BETWEEN '$dari_tanggal' AND '$sampai_tanggal'";
}
...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <div class="mt-3">
            ...
            <a href="../core/export_xlsx.php?jenis=surat_keluar&dari=<?php echo $dari_tanggal; ?>&sampai=<?php echo $sampai_tanggal; ?>" class="btn btn-success">
                <i class="fas fa-file-excel"></i> Download Daftar (XLSX)
            </a>
            <a href="../core/export_zip.php?jenis=surat_keluar&dari=<?php echo $dari_tanggal; ?>&sampai=<?php echo $sampai_tanggal; ?>" class="btn btn-info text-white">

...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <div class="mt-3">
            ...
            <a href="../core/export_csv.php?jenis=surat_keluar&dari=<?php echo $dari_tanggal; ?>&sampai=<?php echo $sampai_tanggal; ?>&keyword=<?php echo urlencode($keyword); ?>" class="btn btn-success">
